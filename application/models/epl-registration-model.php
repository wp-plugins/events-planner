...
class EPL_registration_model extends EPL_model {
    ...
    function calculate_totals() {
        ...
        foreach ( $events as $event_id => $val ) {
            ...
            $dates = $_SESSION['__epl'][$this->regis_id]['_dates']['_epl_start_date'][$event_id];
    ...
    function get_the_dates() {
        ...
        $input_type = $event_details['_epl_event_type'] == 5 ? 'radio' : 'checkbox';
        ...
        foreach ( $dates_data as $event_date_id => $event_date ) {
            ...
            $value = $_SESSION['__epl'][$this->regis_id]['_dates']['_epl_start_date'][$event_details['ID']];
    ...
    function regis_form( $values = null ) {
        ...
        elseif ( $this->mode == 'overview' ) { //overview mode comes after user enters their info in the fields and submits
